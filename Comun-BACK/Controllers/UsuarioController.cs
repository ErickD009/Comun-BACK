  ...
  public async Task<IActionResult> Usuario_Traer_Empresas([FromBody] UsuarioRut usrt)
  {
    ...
    public async Task<IActionResult> Usuario_Enviar_Correo_Recuperacion([FromBody] Email correo)
    {
        try
        {
            ...
            DataSet ds = await Task.Run(() => emailDA.EMAIL_Solicitud_Nueva_Contraseña(correo.De, correo.Para, correo.CC, correo.Asunto, correo.Cuerpo, correo.Adjuntos, correo.EsHtml, correo.NombreSistema, correo.MetodoEnvia));
